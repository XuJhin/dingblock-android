...
public class IndexScroller {
    ...
    // false will always show the sizeIndex bar
    ...
    private boolean showIndexContainer = false; // whether to show the outer sizeIndex container
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                // If down event occurs inside sizeIndex bar region, start indexing
                if (mState != STATE_HIDDEN && contains(ev.getX(), ev.getY())) {
                    setState(STATE_SHOWN);

                    // It demonstrates that the motion event started from sizeIndex bar
                    mIsIndexing = true;
            ...
            case MotionEvent.ACTION_MOVE:
                if (mIsIndexing) {
                    // If this event moves inside sizeIndex bar
    ...
    public void setAdapter(Adapter adapter) {
        ...
        } else if (adapter instanceof CountryListAdapter) {
            CountryListAdapter c = (CountryListAdapter) adapter;
    ...
    private boolean contains(float x, float y) {
        // Determine if the point is in sizeIndex bar region, which includes the right margin of the bar
