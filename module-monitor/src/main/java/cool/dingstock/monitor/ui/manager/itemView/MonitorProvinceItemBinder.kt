...
class MonitorProvinceItemBinder : BaseItemBinder<MonitorCitiesEntity, MonitorProvinceItemBinder.ChildViewHolder>() {
	...
	override fun convert(holder: ChildViewHolder, data: MonitorCitiesEntity) {
