...
import cool.dingstock.appbase.customerview.scroll.findChildUnder
import cool.dingstock.appbase.customerview.scroll.findScrollableTarget
...
class LinkedScrollView: FrameLayout {
    ...
    var naverTouchListener : OnTouchListener? = null
    ...
    override fun dispatchTouchEvent(e: MotionEvent): Boolean {
        naverTouchListener?.onTouch(this,e)
