package cool.dingstock.appbase.helper.snap;
 ...
 * <p>
 * Possible snap positions: {@link Gravity#START}, {@link Gravity#TOP}, {@link Gravity#END}, {@link
 * Gravity#BOTTOM}, {@link Gravity#CENTER}.
 * <p>
 * To customize the scroll duration, use {@link AlignSnapHelper#setScrollMsPerInch(float)}.
 * <p>
 * To customize the maximum scroll distance during flings, use {@link
 * AlignSnapHelper#setMaxFlingSizeFraction(float)} or {@link AlignSnapHelper#setMaxFlingDistance(int)}
 */
public class AlignSnapHelper extends LinearSnapHelper {
	...
	private AlignSnapHelper.SnapListener listener;
	private RecyclerView recyclerView;
	private final RecyclerView.OnScrollListener scrollListener = new RecyclerView.OnScrollListener() {
		@Override
		public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
			super.onScrollStateChanged(recyclerView, newState);
			AlignSnapHelper.this.onScrollStateChanged(newState);
		}
	};
	
	public AlignSnapHelper(int gravity) {
		this(gravity, false, null);
	}
	
	public AlignSnapHelper(int gravity, boolean enableSnapLastItem,
	...
	public AlignSnapHelper(int gravity, @NonNull SnapListener snapListener) {
	...
	/**
	 * Unlike {@link AlignSnapHelper#scrollToPosition(int)}, this method will generally always
	 * find a snap view if the position is valid.
	 * <p>
	 * The smooth scroller from {@link AlignSnapHelper#createScroller(RecyclerView.LayoutManager)}
	 * will be used, and so will {@link AlignSnapHelper#scrollMsPerInch} for the scroll velocity
	 *
	 * @return true if scroll was successful, false otherwise
	 */
	 ...
	 *
	 * @return one of the following: {@link Gravity#START}, {@link Gravity#TOP}, {@link
	 * Gravity#END}, {@link Gravity#BOTTOM}, {@link Gravity#CENTER}
	 */
	...
	/**
	 * Changes the gravity of this {@link AlignSnapHelper} and dispatches a smooth scroll for the
	 * new snap position.
	 *
	 * @param newGravity one of the following: {@link Gravity#START}, {@link Gravity#TOP}, {@link
	 *                   Gravity#END}, {@link Gravity#BOTTOM}, {@link Gravity#CENTER}
	 */
	 ...
	 * @param checkEdgeOfList true if we should check if we're at an edge of the list and snap
	 *                        according to {@link AlignSnapHelper#getSnapLastItem()}, or false to
	 *                        force snapping to the nearest view
	 */
	...
	/**
	 * @return last distance set through {@link AlignSnapHelper#setMaxFlingDistance(int)} or
	 * {@link AlignSnapHelper#FLING_DISTANCE_DISABLE} if we're not limiting the fling distance
	 */
	 ...
	 *
	 * @param distance max fling distance in pixels or {@link AlignSnapHelper#FLING_DISTANCE_DISABLE}
	...
	/**
	 * @return last distance set through {@link AlignSnapHelper#setMaxFlingSizeFraction(float)} or
	 * {@link AlignSnapHelper#FLING_SIZE_FRACTION_DISABLE} if we're not limiting the fling
	 * distance
	 */
	 ...
	 * <p>
	 * Example: if you pass 0.5f and the RecyclerView measures 600dp, the max fling distance will be
	 * 300dp.
	 *
	 * @param fraction size fraction to be used for the max fling distance or {@link
	 *                 AlignSnapHelper#FLING_SIZE_FRACTION_DISABLE} to disable fling limits
	 */
	...
	/**
	 * @return last scroll speed set through {@link AlignSnapHelper#setScrollMsPerInch(float)} or
	 * 100f
	 */
	 ...
	 * <p>
	 * This value will be used in {@link AlignSnapHelper#createScroller(RecyclerView.LayoutManager)}
	 *
	...
	/**
	 * If true, GravitySnapHelper will snap to the gravity edge plus any amount of padding that was
	...
	/**
	 * @return the position of the current view that's snapped or {@link RecyclerView#NO_POSITION}
...
//					recyclerView.scrollBy(distances[0], distances[1]);
	...
	/**
	 * Dispatches a {@link SnapListener#onSnap(int)} event if the snapped position is different than
	 * {@link RecyclerView#NO_POSITION}.
	 * <p>
	 * When {@link AlignSnapHelper#findSnapView(RecyclerView.LayoutManager)} returns null, {@link
	 * AlignSnapHelper#dispatchSnapChangeWhenPositionIsUnknown()} is called
	 *
	...
	/**
	 * Calls {@link AlignSnapHelper#findSnapView(RecyclerView.LayoutManager, boolean)} without the
	 * check for the edge of the list.
	 * <p>
	...
	/**
	 * A listener that's called when the {@link RecyclerView} used by {@link AlignSnapHelper}
	 * changes its scroll state to {@link RecyclerView#SCROLL_STATE_IDLE} and there's a valid snap
	 * position.
	 */
