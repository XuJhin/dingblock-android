...
class FlowLayout @JvmOverloads constructor(
    ...
    init {
        context.obtainStyledAttributes(attributeSet, R.styleable.FlowLayout).use {
            mHorizontalSpacing = it.getDimension(R.styleable.FlowLayout_horizontal_spacing, 10f.azDp).toInt()
            mVerticalSpacing = it.getDimension(R.styleable.FlowLayout_vertical_spacing, 8f.azDp).toInt()
        }
    }
