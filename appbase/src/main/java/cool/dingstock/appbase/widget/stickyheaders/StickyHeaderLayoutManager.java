...
/**
 * StickyHeaderLayoutManager Provides equivalent behavior to a simple LinearLayoutManager, but where
 * section header items are positioned in a "sticky" manner like the section headers in iOS's
 * UITableView. StickyHeaderLayoutManager MUST be used in conjunction with SectioningAdapter.
 *
...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
	 ...
	 * e.g., the adapter position of the item with lowest y value in the list
	 *
	...
	/**
	 * @param fullyVisibleOnly if true, the search will be limited to the last header not hanging
	...
	/**
	 * @param fullyVisibleOnly if true, the search will be limited to the last footer not hanging
	 *                         off bottom of screen
	 *
	 ...
	 * HeaderPosition enum values. This can be useful if client code wants to change appearance for
	 * headers in HeaderPosition.STICKY vs normal positioning.
	 *
	 * @see HeaderPosition
	 */
