...
import cool.dingstock.appbase.widget.danmaku.utils.DanmakuScreenUtil;
...
public class DanmakuManager {
    ...
    public void init(Context context, FrameLayout container) {
        ...
        DanmakuScreenUtil.init(context);
    ...
    public int send(Danmaku danmaku) {
        ...
        if (danmaku.background != 0) {
            view.setBackgroundResource(danmaku.background);
        }

        //padding
        view.setPadding(danmaku.padding[0],danmaku.padding[1],danmaku.padding[2],danmaku.padding[3]);
