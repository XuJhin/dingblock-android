...
public class AnimManager {
    ...
    public void startAnim() {
        ...
        } else if (!TextUtils.isEmpty(imageUrl)||imageRes!=0) {
    ...
    private void createImageAndAnim(final int[] startLocation, final int[] endLocation) {
        if (animModule == AnimModule.SMALL) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(SizeUtils.dp2px(animWidth),
                    SizeUtils.dp2px(animHeight));
            animImageView.setLayoutParams(layoutParams);
            if (!TextUtils.isEmpty(imageUrl)) {
                Glide.with(getActivity()).load(imageUrl).addListener(new RequestListener<Drawable>() {
                    @Override
            ...
            if (imageRes != 0) {
                animImageView.setImageResource(imageRes);
                setAnim(animImageView, startLocation, endLocation);
            }
    ...
    public static final class Builder {
        ...
        public Builder imageResource(@DrawableRes int imageResId) {
