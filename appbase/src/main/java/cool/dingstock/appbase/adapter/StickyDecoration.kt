...
class StickyDecoration(
    ...
    private val testSize: Float = 14.SP,
    private val paddingLeft: Float = 15f.dp,
    private val height: Float = 38f.dp,
...
//        backgroundColor = ContextCompat.getColor(parent.context, R.color.white)
//        textColor = ContextCompat.getColor(parent.context, R.color.color_text_black1)
        var preTag: String?
        ...
        for(i in 0 until parent.childCount) {
            ...
            preTag = curTag
            curTag = tag(position)
            if (curTag.isNullOrEmpty() || TextUtils.equals(preTag, curTag)) continue
