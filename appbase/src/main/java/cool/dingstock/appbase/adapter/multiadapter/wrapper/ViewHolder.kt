...
class ViewHolder(private val mContext: Context, private val convertView: View) :
    ...
    fun setText(viewId: Int, @StringRes textid: Int): ViewHolder {
        val tv = getView<TextView>(viewId)!!
        tv.text = mContext.resources.getString(textid)
        return this
    }
    ...
    fun setChecked(viewId: Int, checked: Boolean): ViewHolder {
        val view =
                getView<View>(viewId) as Checkable
