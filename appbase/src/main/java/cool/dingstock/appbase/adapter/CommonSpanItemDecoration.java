...
public class CommonSpanItemDecoration extends RecyclerView.ItemDecoration {
    private int spanCount;
    private int spacing;
    private int horizontalSpacing;
    private boolean includeEdge;

    public CommonSpanItemDecoration(int spanCount, int spacing, int horizontalSpacing, boolean includeEdge) {
