...
class DcWhiteRefreshHeader(context: Context) : FrameLayout(context), RefreshHeader {
    private val aniView: LottieAnimationView
    private val stateTv: TextView

    init {
        LayoutInflater.from(context).inflate(R.layout.dc_white_refresh_header_layout, this, true)
