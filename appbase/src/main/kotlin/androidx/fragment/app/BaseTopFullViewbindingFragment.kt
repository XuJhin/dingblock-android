 ...
 * 描述：
 **/
abstract class BaseTopFullViewBindingFragment<VB : ViewBinding> :
    DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (!isCreateView.get()) {
            ...
            containerView =
                inflater.inflate(
                    R.layout.base_top_dialog_layout,
                    container,
                    false
                ) as ViewGroup
    ...
    override fun onStart() {
        ...
        context?.let {
            dialog?.window?.navigationBarColor = ContextCompat.getColor(it,R.color.transparent)
