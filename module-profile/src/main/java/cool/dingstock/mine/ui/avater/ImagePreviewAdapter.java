...
import cool.dingstock.imagepre.tool.common.NetworkUtil;
import cool.dingstock.imagepre.tool.image.ImageUtil;
import cool.dingstock.imagepre.tool.ui.PhoneUtil;
import cool.dingstock.imagepre.view.helper.FingerDragHelper;
import cool.dingstock.imagepre.view.helper.ImageSource;
...
public class ImagePreviewAdapter extends PagerAdapter {
                    ...
                    if (imageGif != null) {
                        ...
                        Glide.with(activity)
                                ...
                                .apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.RESOURCE)
                                        .error(ContextCompat.getDrawable(activity, ImagePreview.getInstance().getErrorPlaceHolder())))
                                .into(imageGif);
                    }
                } else {
                    if (imageGif != null) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        View convertView = View.inflate(activity, R.layout.avatar_item_photoview, null);
        ...
        if (ImagePreview.getInstance().isEnableDragClose()) {
            fingerDragHelper.setOnAlphaChangeListener((event, translationY) -> {
                ...
                if (activity instanceof AvatarPreviewActivity) {
                    ((AvatarPreviewActivity) activity).setAlpha(number);
                }
    ...
    public PhotoView getGifView(String url){
        return imageGifHashMap.get(url);
    }

    public SubsamplingScaleImageViewDragClose getImgView(String url){
