...
/**
 * 类名：DcTabLayout
 * 包名：cool.dingstock.lib_base.widget.DcTabLayout
 * 创建时间：2022/2/8 11:07 上午
 * 创建人： WhenYoung
 * 描述：
 **/
/*
...
/**
 * DcTabLayout provides a horizontal layout to display tabs.
 *
 ...
 * DcTabLayout.addTab(DcTabLayout.newTab().setText("Tab 1"));
 * DcTabLayout.addTab(DcTabLayout.newTab().setText("Tab 2"));
 * DcTabLayout.addTab(DcTabLayout.newTab().setText("Tab 3"));
 * </pre>
 * <p>
 * You should add a listener via {@link #addOnTabSelectedListener(OnTabSelectedListener)} to be
 * notified when any tab's selection state has been changed.
 *
 * <p>You can also add items to DcTabLayout in your layout through the use of {@link TabItem}. An
 ...
 */
@ViewPager.DecorView
public class DcTabLayout extends HorizontalScrollView {
     ...
     * DcTabLayout's content width. Fixed tabs have equal width, based on the widest tab label. Once the
    ...
    /**
     * Gravity used to fill the {@link DcTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link DcTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Gravity used to lay out the tabs aligned to the start of the {@link DcTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
     ...
     * DcTabLayout}. This will only take effect if the indicator height is set via the custom indicator
     ...
     * width of the {@link DcTabLayout}. This will disregard {@code tabIndicatorHeight} and the
    ...
    private static final String LOG_TAG = "DcTabLayout";
    @NonNull
    ...
    public DcTabLayout(@NonNull Context context) {
        this(context, null);
    }
    public DcTabLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.tabStyle);
    }
    @SuppressLint("RestrictedApi")
    public DcTabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        if (tab.parent != this) {
            throw new IllegalArgumentException("Tab belongs to a different DcTabLayout.");
        }
    ...
    public void removeTab(@NonNull Tab tab) {
        if (tab.parent != this) {
            throw new IllegalArgumentException("Tab does not belong to this DcTabLayout.");
        }
    ...
    public void removeTabAt(int position) {
        ...
        if (selectedTabPosition == position) {
            selectTab(tabs.isEmpty() ? null : tabs.get(Math.max(0, position - 1)), false);
        }
    }
    ...
    /**
     * Returns the current mode used by this {@link DcTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    /**
     * Set the indicator gravity used to align the tab selection indicator in the {@link DcTabLayout}.
     ...
     * indicator height and stretch across the entire height and width of the {@link DcTabLayout}. This
    ...
    /**
     * Set whether this {@link DcTabLayout} will have an unbounded ripple effect or if ripple will be
    ...
    /**
     * Returns whether this {@link DcTabLayout} has an unbounded ripple effect, or if ripple is bound to
     * the tab item size.
     *
     * @attr ref com.google.android.material.R.styleable#TabLayout_tabUnboundedRipple
    ...
    /**
     * Returns the ripple color for this DcTabLayout.
     *
    ...
    /**
     * Sets the ripple color for this DcTabLayout.
     *
    ...
    /**
     * Sets the ripple color resource for this DcTabLayout.
     *
     * <p>When running on devices with KitKat or below, we draw this color as a filled overlay rather
     * than a ripple.
     *
    ...
    /**
     * Returns the selection indicator drawable for this DcTabLayout.
     *
    ...
    /**
     * Sets the selection indicator for this DcTabLayout. By default, this is a line along the bottom of
     * the tab. If {@code tabIndicatorColor} is specified via the DcTabLayout's style or via {@link
     ...
     *
     * <p>Setting the indicator drawable to null will cause {@link DcTabLayout} to use the default,
    ...
    /**
     * Sets the drawable resource to use as the selection indicator for this DcTabLayout. By default,
     * this is a line along the bottom of the tab. If {@code tabIndicatorColor} is specified via the
     * DcTabLayout's style or via {@link #setSelectedTabIndicatorColor(int)} the selection indicator
    ...
    /**
     * The one-stop shop for setting up this {@link DcTabLayout} with a {@link ViewPager}.
     *
     ...
     * The one-stop shop for setting up this {@link DcTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will link the given ViewPager and this DcTabLayout together so that changes in one
    ...
    /**
     * @deprecated Use {@link #setupWithViewPager(ViewPager)} to link a DcTabLayout with a ViewPager
     * together. When that method is used, the DcTabLayout will be automatically updated when the
        ...
        if (pagerAdapter != null) {
            ...
            if (viewPager != null && adapterCount > 0) {
                ...
                if (curItem != getSelectedTabPosition() && curItem < getTabCount()) {
                    selectTab(getTabAt(curItem), false);
                }
            }
        }
    }
    ...
    private void addViewInternal(final View child) {
        if (child instanceof TabItem) {
            ...
            throw new IllegalArgumentException("Only TabItem instances can be added to DcTabLayout");
        }
    }
        ...
        if (MeasureSpec.getMode(widthMeasureSpec) != MeasureSpec.UNSPECIFIED) {
            ...
            tabMaxWidth =
                    requestedTabMaxWidth > 0
                            ? requestedTabMaxWidth
                            : (int) (specWidth - SizeUtils.dp2px( TAB_MIN_WIDTH_MARGIN));
        }
    ...
    private void animateToTab(int newPosition, boolean hideAni) {
    ...
    /**
     * Called when a selected tab is added. Unselects all other tabs in the DcTabLayout.
     *
     ...
     */
    public void selectTab(@Nullable Tab tab, boolean hideAni) {
        selectTab(tab, true, hideAni);
    }
     ...
     * @see #selectTab(Tab)
     */
    public void selectTab(@Nullable final Tab tab, boolean updateIndicator, boolean hideAni) {
        final Tab currentTab = selectedTab;

        if (currentTab == tab) {
            if (currentTab != null) {
                dispatchTabReselected(tab);
                animateToTab(tab.getPosition(), hideAni);
            }
        } else {
            ...
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == Tab.INVALID_POSITION)
                    ...
                    animateToTab(newPosition, hideAni);
                }
                if (newPosition != Tab.INVALID_POSITION) {
    ...
    public static class Tab {
         ...
         *
         * <p>Do not rely on this if using {@link DcTabLayout#setupWithViewPager(ViewPager)}
         *
        ...
        public Tab setIcon(@DrawableRes int resId) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a DcTabLayout");
            }
        ...
        public void select() {
            ...
            parent.selectTab(this, false);
        }

        public void select(boolean hideAni) {
            if (parent == null) {
                throw new IllegalArgumentException("Tab not attached to a DcTabLayout");
            }
            parent.selectTab(this, hideAni);
        }
     ...
     * provided {@link DcTabLayout} so that the tab position is kept in sync.
     *
     * <p>This class stores the provided DcTabLayout weakly, meaning that you can use {@link
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        @NonNull
        private final WeakReference<DcTabLayout> tabLayoutRef;
        private int previousScrollState;
        private int scrollState;

        public TabLayoutOnPageChangeListener(DcTabLayout DcTabLayout) {
            tabLayoutRef = new WeakReference<>(DcTabLayout);
        }
        ...
        public void onPageScrolled(
            ...
            final DcTabLayout DcTabLayout = tabLayoutRef.get();
            if (DcTabLayout != null) {
                ...
                DcTabLayout.setScrollPosition(position, positionOffset, updateText, updateIndicator);
            }
        }
        ...
        public void onPageSelected(final int position) {
            final DcTabLayout DcTabLayout = tabLayoutRef.get();
            if (DcTabLayout != null
                    && DcTabLayout.getSelectedTabPosition() != position
                    && position < DcTabLayout.getTabCount()) {
                ...
                DcTabLayout.selectTab(DcTabLayout.getTabAt(position), updateIndicator, false);
            }
        }
    ...
    /**
     * A {@link LinearLayout} containing {@link Tab} instances for use with {@link DcTabLayout}.
     */
    public final class TabView extends LinearLayout {
         ...
         * tab background underneath the DcTabLayout selection indicator, and then draw the DcTabLayout
        ...
        protected void drawableStateChanged() {
            ...
            if (changed) {
                invalidate();
                this.invalidate(); // Invalidate DcTabLayout, which draws mBaseBackgroundDrawable
            }
        }
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private void jumpIndicatorToSelectedPosition() {
            ...
            tabIndicatorInterpolator.setIndicatorBoundsForTab(
                    DcTabLayout.this, currentView, tabSelectedIndicator);
        }
         ...
         *                   endTitle the indicator should be drawn. e.g. If a viewpager attached to this DcTabLayout is
        ...
        private void tweenIndicatorPosition(View startTitle, View endTitle, float fraction) {
            ...
            if (hasVisibleTitle) {
                tabIndicatorInterpolator.setIndicatorBoundsForOffset(
                        DcTabLayout.this, startTitle, endTitle, fraction, tabSelectedIndicator);
            } else {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            if (tabSelectedIndicator.getBounds().width() > 0) {
                ...
                // If a tint color has been specified using DcTabLayout's setSelectedTabIndicatorColor, wrap
    ...
    private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
        ...
        public void onAdapterChanged(
            ...
            if (DcTabLayout.this.viewPager == viewPager) {
