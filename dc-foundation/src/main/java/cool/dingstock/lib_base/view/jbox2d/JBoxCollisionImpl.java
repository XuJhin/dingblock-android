package cool.dingstock.lib_base.view.jbox2d;
...
public class JBoxCollisionImpl {
    ...
    private void createWorldChild(boolean change) {
        if (viewGroup != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Object tag = view.getTag(R.id.wd_view_body_need_tag);
                if (tag != null && "need".equalsIgnoreCase(tag.toString())) {
    ...
    private void createBody(View view) {
        ...
        Boolean isShoe = (Boolean) view.getTag(R.id.wd_view_shoe_tag);
    ...
    public void onDraw() {
        ...
        for (int i = 0; i < count; i++) {
            View view = viewGroup.getChildAt(i);
            Object tag = view.getTag(R.id.wd_view_body_need_tag);
            if (isBodyView(view) && "need".equalsIgnoreCase(String.valueOf(tag))) {
