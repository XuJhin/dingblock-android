package cool.dingstock.imagepre.view.helper;
...
import cool.dingstock.imagepre.view.nine.ViewHelper;
...
public class FingerDragHelper extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        if (view != null) {
            if (view instanceof SubsamplingScaleImageViewDragClose) {
                imageView = (SubsamplingScaleImageViewDragClose) view;
            } else if (view instanceof ViewGroup) {
                imageView = (SubsamplingScaleImageViewDragClose)((ViewGroup)view).getChildAt(0);
            }
        }
        View view1 = getChildAt(1);
        if (view1 != null) {
            if (view1 instanceof PhotoView) {
                imageGif = (PhotoView) view1;
            } else if (view1 instanceof ViewGroup) {
                imageGif = (PhotoView)((ViewGroup)view1).getChildAt(1);
            }
        }
    }
