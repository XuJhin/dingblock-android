...
public class ImagePreview {
    ...
    private String avatarPendantName = null;
    private String pendantUrl = null;
    ...
    private String id = "";
    private List<String> allImagesUserNicks;
    ...
    public ImagePreview setImageOwnerList(@NonNull List<String> allImagesUserNicks) {
        this.allImagesUserNicks = allImagesUserNicks;
        return this;
    }

    public List<String> getAllImagesUserNicks() {
        return allImagesUserNicks;
    }
    ...
    public List<ImageInfo> addImageList(ArrayList<ImageInfo> originList, @NonNull List<String> imageList) {
        ImageInfo imageInfo;
        int pos = originList.size();

        for (int i = 0; i < imageList.size(); i++) {
            imageInfo = new ImageInfo();

            Uri oldUrl = Uri.parse(imageList.get(i));
            String newUrl = Uri.parse(oldUrl.toString())
                    .buildUpon()
                    .appendQueryParameter("POS", String.valueOf(pos))
                    .build().toString();
            pos += 1;
            imageInfo.setThumbnailUrl(newUrl);
            imageInfo.setOriginUrl(newUrl);
            originList.add(imageInfo);
        }
        return originList;
    }
    ...
    public ImagePreview setNextKey(Long nextKey) {
    ...
    public ImagePreview setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ImagePreview setUserId(String userId) {
        this.userId = userId;
        return this;
    }

    public String getAvatarPendantName() {
        return avatarPendantName;
    }

    public ImagePreview setAvatarPendantName(String avatarPendantName) {
        this.avatarPendantName = avatarPendantName;
        return this;
    }
    ...
    public ImagePreview setPendantUrl(String pendantUrl) {
        this.pendantUrl = pendantUrl;
        return this;
    }

    public boolean isShowOriginButton(Activity activity, int index) {
        ...
        if (originUrl == null || originUrl.equalsIgnoreCase(thumbUrl)) {// 原图、缩略图url一样，不显示查看原图按钮
            return false;
        }
        // TODO: 2020/11/6
        if (originUrl.endsWith(".gif")) {//如果是Gif
            //判断有没有缓存
    ...
    public ImagePreview setBgColor(String bgColor) {
