...
import static cool.dingstock.imagepicker.data.MediaStoreConstants.BUCKET_ORDER_BY;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.COLUMN_BUCKET_DISPLAY_NAME;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.COLUMN_BUCKET_ID;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.COLUMN_COUNT;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.COLUMN_URI;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.MEDIA_TYPE;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.MEDIA_TYPE_IMAGE;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.MEDIA_TYPE_VIDEO;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.MIME_TYPE;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.QUERY_URI;
import static cool.dingstock.imagepicker.data.MediaStoreConstants.SIZE;
import static cool.dingstock.imagepicker.data.MediaStoreConstants._ID;
