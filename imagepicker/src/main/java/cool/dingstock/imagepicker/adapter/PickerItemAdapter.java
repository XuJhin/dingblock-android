...
public class PickerItemAdapter extends RecyclerView.Adapter<PickerItemAdapter.ItemViewHolder> {
    ...
    //选中图片列表
    private final ArrayList<ImageItem> selectList;
    private final BaseSelectConfig selectConfig;
    private final IPickerPresenter presenter;
    ...
    public void onBindViewHolder(@NonNull final PickerItemAdapter.ItemViewHolder viewHolder, final int position) {
        ...
        boolean hasArrivedMax = selectList.size() >= selectConfig.getMaxCount();
        ...
        pickerItemView.enableItem(imageItem, indexOfSelectList >= 0, indexOfSelectList, hasArrivedMax);
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        private final PickerItemView pickerItemView;
