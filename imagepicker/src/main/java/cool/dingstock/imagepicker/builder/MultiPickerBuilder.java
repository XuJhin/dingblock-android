package cool.dingstock.imagepicker.builder;
...
import cool.dingstock.imagepicker.activity.multi.MultiImagePickerFragment;
...
import cool.dingstock.imagepicker.bean.SelectMode;
...
public class MultiPickerBuilder {
    ...
    public MultiImagePickerFragment pickWithFragment(OnImagePickCompleteListener completeListener) {
        ...
        bundle.putSerializable(MultiImagePickerActivity.INTENT_KEY_SELECT_CONFIG, selectConfig);
        bundle.putSerializable(MultiImagePickerActivity.INTENT_KEY_PRESENTER, presenter);
