...
import cool.dingstock.post.item.LocationPermissionItemBinder
import cool.dingstock.post.item.OnConvertListener
...
class BasicPostListFragment :
    BaseVPLazyFragment<BasicPostViewModel, HomeFragmentRecommendPostBinding>() {
    ...
    private fun asyncUI() {
        viewModel.apply {
            nearbyHeaderLiveData.observe(viewLifecycleOwner) {
            ...
            loadmoreList.observe(viewLifecycleOwner) {
    ...
    companion object {
         ...
         * @return
         */
        fun getInstance(postType: String?): BasicPostListFragment {
            val param = BasicPostListFragment()
            val bundle = Bundle()
